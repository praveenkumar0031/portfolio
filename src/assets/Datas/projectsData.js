...
{ id: 8, title: "Coach Desk",type:"Solo", tech: "React-vite,Tailwindcss,Express,node,Firebase",des:"A full-stack Coach Management Admin Panel built with React (Vite) on the frontend and Node.js + Express + Firebase Realtime Database on the backend. The system allows administrators to manage coaches — including adding, updating, filtering, sorting, and deleting — with a responsive and elegant interface.",url:projectpic8,link:"https://github.com/praveenkumar0031/CoachDesk",live:"https://coach-desk-dev.vercel.app" },
